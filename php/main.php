  ...
  <body>
    ...
    <div class="div_register">
      ...
      if($login){ // 로그인이 되어있는 경우 메인 페이지에 사용자 이름이 뜬다.
        ...
        ?>
        <button  id="logout" type="button" name="button" onclick="location.href='logout.php'">로그아웃</button>
      <?php  }
      else{// 로그인이 되어있지 않은 경우 로그인 버튼과 회원가입 버튼이 뜬다.
        ?>
        <p id= "login_btn" onclick="location.href='../html/login.html'">LOGIN</p>   <!--로그인버튼 -->
        <p id= "join_btn" onclick="location.href='../html/join.html'">JOIN</p>  <!--회원가입 버튼 -->
  <?php } ?>
      </div>
      <!-- 웹페이지 타이틀 -->
    <div class="div_top" >
    ...
    <div class="menu">
      <ul>
        ...
        <li class="menu_btn"><a href="../html/style.html"> clothes </a>|</li>
        <li class="menu_btn"><a href="#"> styleshare </a>|</li>
        <li class="menu_btn"><a href="../html/shoppingmall.html"> shoppingmall </a></li>
      </ul>
      </div>
      <!--배너 꾸미기용 사진 -->
