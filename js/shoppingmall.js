$(document).ready(function(){
  $('#style1').click(function(){
    ...
    $('#shoppingmall_body').append("<div class='shoppingmall_icon'>"+
      ...
      "<p>육육걸즈</p></div>");
    $('#shoppingmall_body').append("<div class='shoppingmall_icon'>"+
     "<a href='https://66girls.co.kr/' target='_blank'><img src='../images/shoppingmall_icon/쇼퍼랜드.png' alt='쇼퍼랜드'></a>"+
     "<p>쇼퍼랜드</p></div>");
    $('#shoppingmall_body').append("<div class='shoppingmall_icon'>"+
      "<a href='https://66girls.co.kr/' target='_blank'><img src='../images/shoppingmall_icon/98.png' alt='98도씨'></a>"+
      "<p>98도씨</p></div>");
    $('#shoppingmall_body').append("<div class='shoppingmall_icon'>"+
      "<a href='https://66girls.co.kr/' target='_blank'><img src='../images/shoppingmall_icon/데쥬.png' alt='데쥬'></a>"+
      "<p>데쥬</p></div>");
  ...
  $('#style3').click(function(){
    ...
    $('#shoppingmall_body').empty();
    $('#shoppingmall_body').append("<div class='shoppingmall_icon'>"+
      "<a href='https://merongshop.com/' target='_blank'><img src='../images/shoppingmall_icon/메롱샵.jpg' alt='육육걸즈'></a>"+
      "<p>메롱샵</p></div>");
    $('#shoppingmall_body').append("<div class='shoppingmall_icon'>"+
     "<a href='https://madejay.com/' target='_blank'><img src='../images/shoppingmall_icon/메이드제이.jpg' alt='쇼퍼랜드'></a>"+
     "<p>메이드제이</p></div>");
    $('#shoppingmall_body').append("<div class='shoppingmall_icon'>"+
      "<a href='https://muahmuah.co.kr/' target='_blank'><img src='../images/shoppingmall_icon/무아무아.jpg' alt='98도씨'></a>"+
      "<p>무아무아</p></div>");
  });
